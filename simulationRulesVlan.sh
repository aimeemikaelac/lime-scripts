...
echo ""
curl -d '{"switch": "00:00:d2:a0:2a:32:2c:48", "name":"mod-6", "priority":"100", "ingress-port":"9", "active":"true", "actions":"set-vlan-id=1,output=4"}' http://192.168.1.3:8080/wm/staticflowentrypusher/json
echo ""
