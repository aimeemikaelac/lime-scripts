...
curl -d '{"switch": "00:00:ee:79:fd:4a:92:4f", "name":"mod-1", "priority":"100", "ingress-port":"11", "active":"true", "actions":""}' http://192.168.1.3:8080/wm/staticflowentrypusher/json
echo ""
curl -d '{"switch": "00:00:ee:79:fd:4a:92:4f", "name":"mod-2", "priority":"100", "ingress-port":"12", "active":"true", "actions":""}' http://192.168.1.3:8080/wm/staticflowentrypusher/json
echo ""
