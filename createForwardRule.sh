...
curl -d '{"switch": "$3", "name":"mod-$1_to_$2", "priority":"100", "ingress-port":"$1", "active":"true", "actions":"output=$2"}' http://192.168.1.3:8080/wm/staticflowentrypusher/json
echo ""
echo "Wrote rule link ports $1 and $2 on switch $3"
